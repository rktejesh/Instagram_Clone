...
const List<Story> stories = [
  Story(
    url:
    'https://static.videezy.com/system/repositories/previews/000/005/529/original/Reaviling_Sjusj%C3%B8en_Ski_Senter.mp4',
  ...
  Story(
    url:
    'https://static.videezy.com/system/repositories/previews/000/007/536/original/rockybeach.mp4',
    media: MediaType.video,
